...
class IntlTelInput extends Component {
  ...
  componentDidMount() {
    ...
    this.dropdownContainer = this.props.dropdownContainer
...
IntlTelInput.propTypes = {
  ...
  /** Instead of putting the country dropdown next to the input, append it to the specified node, and it will then be positioned absolutely next to the input using JavaScript */
